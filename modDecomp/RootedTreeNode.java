...
class RootedTreeNode {
     ...
     * @return
     */
    public BitSet getStrongModulesBool(Map<String, Integer> vertexToIndex, ArrayList<MDTreeLeafNode> leaves, HashMap<BitSet, RootedTreeNode> modules) {
